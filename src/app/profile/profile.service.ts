...
Completed my Secondary school with 84%.`
  ...
  //   },

    {
      ...
      work: `Technologies : Angular , JavaScript , TypeScript , MySQl ,Rest Api's.

  .  Developed and maintained web applications using Angular 8+.
  .  Implemented responsive UI designs using HTML5, CSS3, and Bootstrap5.
  .  Used GitLab for version control and collaborated with the team using GitLab.
  .  Debugged and resolved issues reported by end-users.
  .  Worked closely with back-end developers to integrate  Rest APIs with front-end using Angular HttpModule
  . Optimized application performance and responsiveness by implementing lazy loading and other performance optimization techniques `
    },
